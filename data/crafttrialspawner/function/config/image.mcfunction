function crafttrialspawner:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    "Craft Trial Spawner & Keys",\
    {text: "Crafting recipes for Trial Spawner, Keys and Vaults", color: "#aaaaaa"},\
    "",\
    ...
    {text: "modrinth.com/datapack/craft-trial-spawner-key", color: "#a800a8"},\
    "",\
    "",\
    "",\
    "",\
